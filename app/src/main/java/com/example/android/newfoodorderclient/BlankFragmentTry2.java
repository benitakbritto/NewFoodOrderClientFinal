...
public class BlankFragmentTry2 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_blank_fragment_try2, container, false);
        // return
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Maincourse");
    ...
    public static BlankFragmentTry2 newInstance(String param1, String param2) {
        BlankFragmentTry2 fragment = new BlankFragmentTry2();
            ...
            protected void populateViewHolder(Starters.FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleFoodActivity = new Intent(getActivity(), SingleFoodActivityMainCourse.class);
