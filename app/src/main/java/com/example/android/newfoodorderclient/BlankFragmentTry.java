...
public class BlankFragmentTry extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_blank_fragment_try, container, false);
       // return
            ...
            protected void populateViewHolder(Starters.FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleFoodActivity = new Intent(getActivity(), SingleFoodActivityStarters.class);
