...
public class Dessert extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseAuth.getCurrentUser() == null) {
                    Intent loginIntent = new Intent(Dessert.this, MainActivity.class);
            ...
            protected void populateViewHolder(FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleFoodActivity = new Intent(Dessert.this, SingleFoodActivityDessert.class);
    ...
    public void billingPage(View view) {
        Intent billIntent = new Intent(Dessert.this, OpenBill.class);
